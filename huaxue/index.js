...
class Player {
    ...
    setupModel() {
        ...
        world.loadFbx('player', '../snow-game/sources/player@skateboarding.fbx', true)
        world.loadFbx('playerDying', '../snow-game/sources/player@dying.fbx', false)
        world.loadFbx('snowboard', '../snow-game/sources/snowboard.fbx', true)
...
class Mountain {
    constructor(world, player) {
        ...
        const snowMap = new THREE.TextureLoader().load('../snow-game/img/snow.jpg')
